...
var COLS = {
  ...
  HANG_CHO:   ['MA_CHO','NGAY','STT','MA_BN','TRANG_THAI','BS_KHAM','GHI_CHU','DV_YEU_CAU','BS_YEU_CAU','BS_YEU_CAU_SA','MA_HEN','UU_TIEN','LY_DO_HUY','GIO_TIEP_NHAN','GIO_GOI','GIO_XONG','GIO_THU','NGUOI_GT'],
  SO_KHAM:    ['MA_LUOT','NGAY','MA_BN','TEN_DV','BS_THUC_HIEN','BS_CHI_DINH','DON_GIA','SO_LUONG','THANH_TIEN','GHI_CHU','ANH_KET_QUA','MA_CHO','TRANG_THAI_DV','NGUOI_XAC_NHAN','GIO_XAC_NHAN','KET_QUA','MA_TT'],
  ...
  LICH_HEN:   ['MA_HEN','NGAY_HEN','GIO_HEN','MA_BN','LY_DO','BS_PHU_TRACH','TRANG_THAI','GHI_CHU','LOAI','TU_DONG','NGUOI_GT'],
  THAI_KY:    ['MA_TK','MA_BN','KINH_CUOI','TRANG_THAI','GHI_CHU'],
  THUOC:      ['MA_THUOC','TEN_THUOC','HOAT_CHAT','DVT','NHOM','GIA_VON','GIA_BAN','TON_TOI_THIEU','CON_AP_DUNG','GHI_CHU','MA_VACH','THANH_PHAN'],
