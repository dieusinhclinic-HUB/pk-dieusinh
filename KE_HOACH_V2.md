...
## 4c. NHẬT KÝ XÂY DỰNG
- **Cập nhật giá XN theo file BẢNG GIÁ PKBH 2026 + 10 combo XN + HÓA ĐƠN BỔ SUNG (14/9/2026):** (1) So file với hệ thống: 89/97 XN trùng khớp (file chính là bảng giá đã nhập 9/9); 8 giá lệch được cập nhật theo file (anh Khang chốt): TPT nước tiểu 90k, AMH 850k, Test 75gr đường 200k, HIV 150k, HBsAg 125k, VDRL 120k, HCG QS 90k, cấy+KSĐ 400k. (2) Thêm 10 gói COMBO XN (DV601–DV610, nhóm Xét nghiệm, GHI_CHU 'Bảng giá 2026 — Combo XN', hiện thành nhóm riêng trong dropdown): Huyết học 320k · Đông máu 760k · Gan-Thận-Đường 450k · Bộ mỡ 220k · Miễn dịch 450k · Tuyến giáp T3+T4 410k · TSH+FreeT4 310k · Nội tiết 1.210k · TORCH 2.265k · PAP+HPV 1.000k. (3) HÓA ĐƠN BỔ SUNG: cột mới SO_KHAM.MA_TT — khi thu tiền, TỪNG dòng dịch vụ được gắn số phiếu thu; nút +DV giờ có cả ở nhóm Đã thu; lượt Đã thu có phát sinh (dịch vụ chưa gắn phiếu / toa chưa gắn MA_TT) hiện nút "＋ TT bổ sung" → chỉ tính phần phát sinh, in PHIẾU THANH TOÁN BỔ SUNG, ghi chú rõ; dữ liệu cũ suy theo giờ (dòng xác nhận trước GIO_THU coi như đã thu) nên không tính trùng. Còn treo: HBsAg thứ 2 trong file giá '???' và PT/INR/APTT/Fibrinogen chưa có giá (combo ghi 300k) — chờ chị chủ chốt. version.json → 2026-09-14.1.
- **Hiện HỌ TÊN nhân viên thay vì nick email (13/9/2026):** trước đây phiếu thu, toa in, dòng "✓ đã xác nhận", "Soạn/Phát", "bởi …" hiện nick email (vd kimhabino) — nay tra bảng NGUOI_DUNG đổi thành HỌ TÊN (vd Kim Hà). Thêm pkTenNV() dùng chung (supabase-api.js, tự nạp EMAIL→HO_TEN sau đăng nhập); áp dụng: phiếu thu (chữ ký Thu ngân), toa in (Người nhập), bệnh án, bàn khám, thư ký, dược sỹ (Soạn/Phát, ghi chú kho "bởi …"), tổng quan (đối soát thu ngân). Cột dữ liệu vẫn lưu EMAIL để truy vết — chỉ đổi khi HIỂN THỊ; ghi chú tự do (GHI_CHU) từ nay ghi thẳng họ tên. Dữ liệu cũ hiện đúng tên luôn vì đổi lúc hiển thị. version.json → 2026-09-13.3.
- **Bỏ hẳn mục "Hay dùng" trên toàn hệ thống (13/9/2026):** rà toàn bộ mã — chỉ còn 1 chỗ: form Tiếp nhận bệnh nhân ở Lễ tân (6 chip dịch vụ gợi ý). Đã gỡ; chọn dịch vụ giờ thống nhất một kiểu ở mọi màn hình: Nhóm dịch vụ → chọn món, hoặc gõ tìm nhanh. Dọn luôn hàm topDVs không còn dùng ở Lễ tân + Bàn khám. version.json → 2026-09-13.2.
- **Kế toán chị Linh + báo cáo theo NĂM + XNT vật tư (13/9/2026):** thêm tài khoản linhktdieusinh@gmail.com vai trò **Kế toán** (NGUOI_DUNG; RLS sẵn có: chỉ XEM, không sửa; đăng nhập Google ở link chính → tự vào Tổng quan). Chọn phương án A — Kế toán dùng chung Tổng quan (không làm giao diện riêng: đỡ trùng lặp code, số liệu một nguồn, RLS đã khóa ghi). Tổng quan bổ sung: (1) Doanh thu lũy kế thêm nút **Theo năm** (mỗi năm: số hóa đơn · doanh thu · lũy kế toàn hệ thống); (2) thẻ mới **Xuất – Nhập – Tồn vật tư tiêu hao** — chọn tháng, mỗi vật tư: tồn đầu + nhập − xuất ± kiểm kê = tồn cuối (bảng VAT_TU × VT_GD), ô tìm, dòng TỔNG, nút Xuất CSV. version.json → 2026-09-13.1.
- **Ô BS thực hiện siêu âm = TOÀN BỘ bác sĩ (11/9/2026):** dropdown "TH:" liệt kê cả đội ngũ đang làm việc (BS siêu âm xếp trước) — vì BS khám cũng tự làm được một số siêu âm. Điều phối bổ sung: siêu âm ghim cho BS KHÁM thì nằm trong hàng chờ của chính BS đó (kể cả khi lượt bị ghim khám cho BS khác); phòng SA chỉ nhận thay khi người được ghim đang bận. version.json → 2026-09-11.7.
